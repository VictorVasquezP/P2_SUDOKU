...
public class PrincipalFrame extends JFrame{
    ...
    public PrincipalFrame() throws IOException, FileNotFoundException, ModoAperturaIncorrectoException{
        ...
        encabezado=new JPanel(new FlowLayout((int)CENTER_ALIGNMENT,20,20));
        ...
        t05= new JTextField();
        t05.setBackground(Color.decode("#FBFBEF"));
        t06= new JTextField();
        ...
        t24= new JTextField();
        t24.setBackground(Color.decode("#FBFBEF"));
        t25= new JTextField();
        ...
        t36= new JTextField();
        t36.setBackground(Color.decode("#FBFBEF"));
        t37= new JTextField();
        t37.setBackground(Color.decode("#FBFBEF"));
        t38= new JTextField();
        t38.setBackground(Color.decode("#FBFBEF"));
        t40= new JTextField();
        t40.setBackground(Color.decode("#FBFBEF"));
        t41= new JTextField();
        t41.setBackground(Color.decode("#FBFBEF"));
        t42= new JTextField();
        t42.setBackground(Color.decode("#FBFBEF"));
        t43= new JTextField();
        ...
        t46= new JTextField();
        t46.setBackground(Color.decode("#FBFBEF"));
        t47= new JTextField();
        t47.setBackground(Color.decode("#FBFBEF"));
        t48= new JTextField();
        t48.setBackground(Color.decode("#FBFBEF"));
        t50= new JTextField();
        t50.setBackground(Color.decode("#FBFBEF"));
        t51= new JTextField();
        t51.setBackground(Color.decode("#FBFBEF"));
        t52= new JTextField();
        t52.setBackground(Color.decode("#FBFBEF"));
        t53= new JTextField();
        ...
        t64= new JTextField();
        t64.setBackground(Color.decode("#FBFBEF"));
        t65= new JTextField();
        ...
        t74= new JTextField();
        t74.setBackground(Color.decode("#FBFBEF"));
        t75= new JTextField();
        ...
        t83= new JTextField();
        t83.setBackground(Color.decode("#FBFBEF"));
        t84= new JTextField();
